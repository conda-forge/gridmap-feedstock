...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gridmap-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10934&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gridmap-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gridmap` can be installed with:

```
conda install gridmap
```

It is possible to list all of the versions of `gridmap` available on your platform with:
